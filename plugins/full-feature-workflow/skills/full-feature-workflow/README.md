...
Run an entire feature end-to-end — Jira intake, code change, review hand-off, commit + MR, and Slack pings to blame authors — by orchestrating the other skills in this marketplace.
...
```mermaid
flowchart LR
    A["/full-feature-workflow PROJ-1234"] --> B[✅ Spec → code → MR → DMs sent]
```
...
```
/full-feature-workflow PROJ-1234
```

```
/full-feature-workflow https://your-org.atlassian.net/wiki/spaces/ENG/pages/12345/Spec
```
...
```
/full-feature-workflow https://your-org.atlassian.net/wiki/.../page-id/Spec
```
