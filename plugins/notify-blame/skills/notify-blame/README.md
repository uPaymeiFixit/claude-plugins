...
```
/notify-blame https://gitlab.example.com/team/my-service/-/merge_requests/306
```
...
- **Optional**: improve performance with the [person-to-user-map](../../../person-to-user-map/skills/person-to-user-map/README.md) skill
